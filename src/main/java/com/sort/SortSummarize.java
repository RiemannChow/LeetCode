...
public class SortSummarize {
    public static void main(String[] args) {
        ...
        System.out.println("选择排序 " + Arrays.toString(selectSort(a)));
        System.out.println("冒泡排序 " + Arrays.toString(bubbleSort(a)));
        System.out.println("插入排序 " + Arrays.toString(insertSort(a)));
        System.out.println("归并排序 " + Arrays.toString(mergeSort(a)));
        System.out.println("希尔排序 " + Arrays.toString(shellSort(a)));
        System.out.println("堆排序   " + Arrays.toString(heapSort(a)));
